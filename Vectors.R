...
x1
y
y[y>15]#subset/ filter values on condition, position----
...
(x4 = c(rep(c(1,3,5) , times=c(2,3,4))))
plot(y)
(y2 = seq(from=1, to=99, by=3))
(x4 = c(rep(4,times=3), rep(7, times=4)))
(y3 = c(rep(6,3) , rep(7,3)))
(x5 = c(rep(c(1,2,3), times=c(5,4,3))))
ls()
#Using probability Distributions
(x6 = rnorm(n=10000, mean=5, sd=1))

(y= rnorm(n=20, mean=7, sd=.25))
plot(density(y))
abline(v=7, h=.75)
mean(y)
mode(y)plot(density(x6))
abline(v=5, h=.2, col=2:1)
